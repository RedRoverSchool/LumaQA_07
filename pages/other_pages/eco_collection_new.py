...
class CollectionPage(BasePage):
    ...
    TEXT = ['Bruno Compete Hoodie', 'Layla Tee', 'Fiona Fitness Short', 'Stellar Solar Jacket', 'Elisa EverCool™ Tee']
    TITLE_ALL = (By.CSS_SELECTOR, 'ol.product-items.widget-product-grid')
    ITEMS_TEXT = ["Bruno Compete Hoodie", "Layla Tee", "Fiona Fitness Short", "Stellar Solar Jacket", "Elisa EverCool™ "
                                                                                                     "Tee"]
